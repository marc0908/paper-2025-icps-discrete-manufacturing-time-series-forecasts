...
def patchtst_searchspace():
    """
    PatchTST search space for long-term multivariate forecasting.

    Design choices are centered around the paper defaults:
    - channel-independent, per-channel Transformer
    - 3 encoder layers, d_model=128, H=16, dropout≈0.2  [oai_citation:1‡PatchTST.pdf](sediment://file_00000000345071f48eacecf48aff9fd0)
    - patch length P=16, stride S=8 for L=336/512 in the paper; we generalize this for L=1600  [oai_citation:2‡PatchTST.pdf](sediment://file_00000000345071f48eacecf48aff9fd0)
    """
    search_space = {
